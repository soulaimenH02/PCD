"""
🐦 CLASSIFICATION OISEAU OU BRUIT AVEC OPENCV
===============================================
OpenCV est utilisé pour :
1. Lire et prétraiter les images
2. Détecter les oiseaux en temps réel (webcam)
3. Afficher les résultats sur l'écran

Installation :
    pip install opencv-python tensorflow pillow numpy

Lancer :
    python opencv_oiseau_bruit.py
"""
...
# ⚙️  CONFIGURATION
# ─────────────────────────────────────────────────────────────
MODELE_PATH  = r"/home/islem/modeles/model_oiseau_bruit.h5"
IMG_SIZE     = (224, 224)
...
# ─────────────────────────────────────────────────────────────
# 📁 MODE 2 : TESTER UN DOSSIER D'IMAGES
# ─────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────
# 🎥 MODE 3 : DÉTECTION EN TEMPS RÉEL (WEBCAM)
# ─────────────────────────────────────────────────────────────
